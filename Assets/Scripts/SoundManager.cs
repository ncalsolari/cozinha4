...
public class SoundManager : MonoBehaviour {
    ...
    private void Start() {
        DeliveryManager.Instance.OnRecipeSucess += Delivery_OnRecipeSucess;
        DeliveryManager.Instance.OnRecipeFailed += Delivery_OnRecipeFailed;
        CuttingCounter.OnAnyCut += CuttingCounter_OnAnyCut;
        Player.Instance.OnPickedSomething += Player_OnPickedSomething;
        BaseCounter.OnAnyObjectPlaceHere += BaseCounter_OnAnyObjectPlacedHere;
    ...
    private void Delivery_OnRecipeSucess(object sender, System.EventArgs e) {
